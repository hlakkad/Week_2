...
main_menu=['0.Exit App','1.Product Menu','2.Couriers menu','3.Order Menu']
...
def write_into_data_file(data_list):
...
def Add_data(data_list):
    ...
    write_into_data_file(data_list)
...
def Start():
    All_Menu()
    main_menu_choice = input("Enter choice from 0 to 3:")
    if main_menu_choice in ('0','1','2','3'):
        if main_menu_choice == '0':
            ...
            order.Order_Menu_Logic(order.order_choice) 
        else:
         print("Invalid Input")
